...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CEsyPKS6.js
...
var styles_default = "/assets/styles-YoCAGvhe.css";
var APP_NAME = "Neon Club Live";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Free interactive nightclub — type 1 to join the floor. Gifts unlock fireworks."
			},
			{
...
function RootComponent() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, { children: [
...
var $$splitComponentImporter$3 = () => import("./routes-D1xkVYb2.mjs");
var Route$3 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$3, "component"),
	head: () => ({ meta: [{ title: "Neon Club Live · Host Control" }] })
});
var $$splitComponentImporter$2 = () => import("./content-Bi2USDiG.mjs");
var Route$2 = createFileRoute("/content")({
	component: lazyRouteComponent($$splitComponentImporter$2, "component"),
	head: () => ({ meta: [{ title: "Global EN Content Pack · QuanBar" }] })
});
var $$splitComponentImporter$1 = () => import("./overlay-cuulPM8R.mjs");
var Route$1 = createFileRoute("/overlay")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: "Neon Club Live · OBS Overlay" }] })
});
var $$splitComponentImporter = () => import("./content._slug-BMoW7avi.mjs");
var Route = createFileRoute("/content/$slug")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: ({ params }) => ({ meta: [{ title: `${params.slug} · Global EN Pack` }] })
});
...
var OverlayRoute = Route$1.update({
	id: "/overlay",
	path: "/overlay",
	getParentRoute: () => Route$4
});
var ContentRouteChildren = { ContentSlugRoute: Route.update({
	id: "/$slug",
	path: "/$slug",
...
var rootRouteChildren = {
	IndexRoute,
	ContentRoute: ContentRoute._addFileChildren(ContentRouteChildren),
	OverlayRoute
};
